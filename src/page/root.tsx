...
export default async function Root({ children }: PropsWithChildren) {
  return (
    <html lang="en">
      <head>
        <meta charSet="utf-8" />
        ...
        <meta property="og:image" content="https://prettycoffee.dev/preview-og.png" />
        ...
        <meta name="twitter:image" content="https://prettycoffee.dev/preview-og.png" />
      </head>

import { styled, css, recipe } from "lib/goober"
import { theme } from "utils/theme"

export const cardStyles = recipe<{ inverted?: boolean }>(({ inverted }) => [
  css`
...
export const Card = styled.div(cardStyles).filterProps(["inverted"])
